...
class NvdMesh():
    ...
    def standardize_mesh(self,inplace=False):
        ...
        return nvd_utils.standardize_mesh(mesh)

    def normalize_mesh(self,inplace=False):

        mesh = self if inplace else copy.deepcopy(self)
        return nvd_utils.normalize_mesh(mesh)
    ...
    def set_mesh_color(self,color):
        self.texture_map = nvd_utils.get_texture_map_from_color(self,color)
        self.face_attributes = nvd_utils.get_face_attributes_from_color(self,color)
    ...
    def divide(self,inplace=True):
        ...
        mesh = self if inplace else copy.deepcopy(self)
        new_vertices, new_faces, new_face_uvs = nvd_utils.add_vertices(mesh)
